...
- **Real-Time Bidding (RTB)**: Direct campaign-to-RTB target assignments, supporting external bidder integration, real-time auctions, and predictive routing based on performance.
