...
import { Phone, BarChart3, BellRing, Users, PhoneCall, Settings, DollarSign, PhoneForwarded, Mic, Zap, UserCheck, LogOut, HelpCircle, Globe, Menu, X } from "lucide-react";
        ...
        {navigation.map((item) => {
          ...
          return (
            <Link 
              key={item.name} 
              href={item.href}
              className="flex items-center px-3 py-2 font-medium rounded-lg transition-colors cursor-pointer relative group text-primary-600 bg-primary-50 justify-center text-[20px]"
