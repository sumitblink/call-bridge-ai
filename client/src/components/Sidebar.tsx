...
import { Phone, BarChart3, BellRing, Users, PhoneCall, Settings, DollarSign, PhoneForwarded, Mic, Zap, UserCheck, LogOut, HelpCircle, Globe, TestTube } from "lucide-react";
...
const navigation = [
  ...
  { name: "Call Flow Demo", href: "/call-flow-demo", icon: PhoneCall, current: false },
  { name: "Testing", href: "/testing", icon: TestTube, current: false },
